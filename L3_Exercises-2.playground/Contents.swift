...
var boolArray = [Bool](count: 5, repeatedValue: false);
...
waitingList.removeAtIndex(waitingList.indexOf("Lyla")!)
waitingList.removeAtIndex(waitingList.indexOf("Daniel")!)
...
var anotherDictionary = ["Anchovies": true, "Coconut": true, "Cilantro": true, "Liver": false]
...
if let bo = presidentialDogs["Michele Obama"] {
